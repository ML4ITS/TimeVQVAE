...
class Evaluation(object):
    ...
    - t-SNE
    """
    def __init__(self, subset_dataset_name: str, gpu_device_index: int, config: dict, batch_size: int, use_domain_shifter: bool, **kwargs):
        self.subset_dataset_name = subset_dataset_name
        self.device = torch.device(gpu_device_index)
        self.batch_size = batch_size
        self.config = config
        self.use_domain_shifter = use_domain_shifter
